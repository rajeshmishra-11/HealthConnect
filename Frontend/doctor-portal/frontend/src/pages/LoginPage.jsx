        ...
        <div className="flex min-h-[80vh] items-center justify-center">
            <div className="w-full max-w-md p-8 bg-card rounded-2xl shadow-xl border border-border">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold font-lexend text-foreground">Doctor Login</h1>
                    <p className="text-muted-foreground mt-2">Enter your credentials to access the clinic portal</p>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-border text-center">
                    <p className="text-xs text-muted-foreground">
                        Healthcare professionals only. Access is monitored and logged for security compliance.
                    </p>
                </div>
            </div>
        </div>
